...
class AuthenticatedTestCase(TestCase):
    """
    Base class for creating a :class:`test.TestCase` with an authenticated
...
class LandingPageTests(AuthenticatedTestCase):
    """
...
class LandingPageViewTests(AuthenticatedTestCase):
    """
    Tests :view:`copywriting.LandingPageListView`.
    """
